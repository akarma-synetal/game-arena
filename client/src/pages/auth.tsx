  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30 scroll-smooth">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:50px_50px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000,transparent)]" />
        <motion.div 
      ...
      <motion.nav 
        ...
        className="fixed top-0 w-full z-50 glass-panel border-b border-white/5 px-6 lg:px-16 py-4 flex items-center justify-between backdrop-blur-xl"
      >
        <motion.div 
        ...
        <div className="hidden lg:flex items-center gap-8 uppercase text-xs md:text-sm tracking-[0.4em] font-display font-semibold text-muted-foreground">
          {["Home", "Leaderboard", "Partner", "Blogs", "Plans", "About", "Contact"].map((item, i) => (
            <motion.a
              key={item}
          ...
          >
            <Button
              ...
              variant="ghost"
              className="h-11 px-8 rounded-2xl border-2 border-primary/70 text-primary hover:bg-primary/10 tracking-[0.4em] hover:scale-105 transition-all"
            >
              Player
            </Button>
          </motion.div>
          ...
          >
            <Button
              ...
              className="h-11 px-8 rounded-2xl bg-gradient-to-r from-primary to-accent text-black font-semibold tracking-[0.4em] shadow-[0_0_25px_rgba(255,0,153,0.45)] hover:shadow-[0_0_40px_rgba(255,0,153,0.6)] hover:scale-105 transition-all"
            >
              Partner
            </Button>
          </motion.div>
      ...
      {/* Hero Section */}
      <section id="home" className="relative min-h-screen flex flex-col items-center justify-center pt-28 px-6 overflow-hidden">
        ...
        >
          <div className="text-left max-w-2xl w-full">
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/30 text-primary text-[11px] uppercase tracking-[0.35em] font-display mb-8"
            >
            ...
            <motion.h1 
              ...
              className="text-6xl sm:text-7xl lg:text-[9rem] font-display font-semibold uppercase tracking-tight italic leading-[0.9] mb-6 pr-4 overflow-visible"
            >
              Dominate <br />
              <motion.span 
                initial={{ opacity: 0, scale: 0.8 }}
                ...
                className="inline-block pb-2 pr-4 lg:pr-8 text-transparent bg-clip-text bg-gradient-to-r from-primary via-accent to-secondary text-glow"
              >
                The Grid
              </motion.span>
            </motion.h1>
            <motion.p 
              ...
              className="text-xl lg:text-2xl text-muted-foreground font-sans max-w-xl mb-10"
            >
      ...
      {/* Partners */}
      <section id="partner" className="py-28 px-6 lg:px-16 bg-background border-b border-white/5">
          ...
          >
            ...
            <div className="space-y-4">
              {hostingPartners.map((partner, index) => (
                ...
                >
                  <CyberCard className="p-5 rounded-2xl border-white/10 bg-black/40">
      ...
      <section id="tournaments" className="py-28 px-6 lg:px-16 bg-background relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {tournaments?.slice(0, 3).map((t: any, index: number) => (
              <motion.div
                key={t.id}
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
                ...
                whileHover={{ y: -10 }}
              >
                <CyberCard interactive glowColor="primary" className="p-0 overflow-hidden group">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <motion.h2 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="text-6xl font-display font-bold uppercase tracking-tighter mb-8 leading-tight italic"
            >
              ...
              {[
                ...
                >
                  <motion.div 
                    ...
                    transition={{ type: "spring", stiffness: 300 }}
                    className="w-16 h-16 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center shrink-0 text-primary"
                  >
      ...
      <section className="py-24 px-6 bg-background relative overflow-hidden">
         ...
         <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
            {[
              ...
              >
                <motion.p 
                  className="text-5xl lg:text-7xl font-display font-bold text-glow italic mb-2"
                  animate={{ 
                    textShadow: [
            ...
            {([
              ...
              >
                <CyberCard
                  ...
                  className={`p-8 flex flex-col gap-6 rounded-3xl border-white/10 bg-black/50 h-full ${plan.featured ? "ring-1 ring-primary/40 shadow-[0_0_40px_rgba(255,0,153,0.15)]" : ""}`}
                >
                {plan.featured && (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <CyberCard interactive className="p-6 space-y-4 h-full">
